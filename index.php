...
<div class="hero">
    <div class="container">
        <h1><?php _e( 'Find Your Dream Job', 'job-board-pro' ); ?></h1>
        <p><?php _e( 'Explore thousands of job opportunities with all the information you need.', 'job-board-pro' ); ?></p>
    </div>
</div>
    ...
    <div class="container">
        <div class="job-grid" id="job-results">
            ...
            if ( $query->have_posts() ) {
                ...
                echo '<p>' . __( 'No jobs found.', 'job-board-pro' ) . '</p>';
            }
            wp_reset_postdata();
            ?>
        </div>
